...
app = FastAPI(debug=True, docs_url='/compunnel_facerec/docs', redoc_url='/compunnel_facerec/redocs',openapi_url='/compunnel_facerec/openapi.json')
...
@app.get('/compunnel_facerec', include_in_schema=False)
def index():
    return RedirectResponse('/compunnel_facerec/docs')

@app.post('/compunnel_facerec/face-enroll')
...
@app.post('/compunnel_facerec/face-search')
...
@app.post('/compunnel_facerec/delete-index')
...
@app.post('/compunnel_facerec/drop-collection')
